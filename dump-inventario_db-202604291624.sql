...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `fk_compras_productos` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON UPDATE CASCADE
...
(1,'Redmi','111',2,1500.00,1600.00,20,'2026-04-29 21:09:13');
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT `fk_ventas_productos` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-29 16:24:06
